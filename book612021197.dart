void main() {
  ...
  books.add(Book(bookCode: 'B005', bookTitle: 'Slam Dunk', bookType: 'Cartoon', bookPrice: 100));
  books.add(Book(bookCode: 'B006', bookTitle: 'Doramon', bookType: 'Cartoon', bookPrice:250));

  
  for(int i = 0; i < books.length; i++){
   print("รหัสหนังสือ :"+books[i].bookCode + ", ชื่อหนังสือ :" + books[i].bookTitle +", ประเภทหนังสือ :"+ 
   books[i]. bookType +", ราคาหนังสือ :"+ books[i]. bookPrice.toString() );
